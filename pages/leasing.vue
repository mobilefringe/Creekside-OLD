<template>
  <div class="contact-us-container">
    <inside-page-banner :pageBanner="pageBanner" pageTitle="Leasing"></inside-page-banner>
    ...
    <div class="main_container">
      ...
      <div class="row">
        <div class="col-md-12 margin_60 leasing_main">
...
export default {
  ...
  async asyncData({ store, params, route }) {
    try {
      let results = await Promise.all([
        store.dispatch('LOAD_SEO', { url: '/leasing' }),
  ...
  methods: {
    updateCurrentPage() {
      this.currentPage = this.findPageBySlug('creekside-leasing')
