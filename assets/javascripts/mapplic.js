...
(function($) {
    ...
    var Mapplic = function(element) {
        ...
        self.init = function(options) {
            ...
            options.tooltiplabel ? (self.loc.more = options.tooltiplabel) : false
        ...
        function Tooltip() {
            ...
            this.init = function() {
                ...
                this.close = $('<a>Close</a>').addClass('mapplic-tooltip-close').attr('href', '#').appendTo(this.wrap);
                ...
                this.title = $('<h2></h2>').addClass('mapplic-tooltip-title').appendTo(this.wrap);
            ...
            this.search = function() {
                ...
                $.each(self.g, function(i, group) {
                    if (group.list) {
                        ...
                        else $.each(self.o.searchfields, function(i, field) {
        ...
        function ZoomButtons() {
            ...
            this.init = function() {
                ...
                // zoom-in button
                this.zoomin = $('<a>zoomin</a>').attr('href', '#').addClass('mapplic-button mapplic-zoomin-button').appendTo(this.el);
                ...
                // zoom-out button
                this.zoomout = $('<a>zoomout</a>').attr('href', '#').addClass('mapplic-button mapplic-zoomout-button').appendTo(this.el);
